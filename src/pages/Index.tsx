...
const Index = () => {
  ...
  if (accepted) {
    return <div className="fixed inset-0 overflow-y-auto celebration-bg">
        <CelebrationEffects />
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center relative z-10">
          ...
          <div className={`w-full max-w-sm transition-all duration-1000 ease-out ${showDateReveal ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="bg-card/70 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-primary/15 mb-6">
              ...
              <p className="text-muted-foreground text-sm sm:text-base">Sorry not revealing it yet</p>
            </div>
  ...
  return <div ref={containerRef} className="fixed inset-0 flex flex-col items-center justify-center p-6">
      ...
      <div className="flex flex-col items-center max-w-md w-full relative z-10">
        ...
        <div className="flex gap-4 items-center">
          <button onClick={handleYes} className="px-8 py-4 rounded-full bg-primary text-primary-foreground font-bold text-lg md:text-xl shadow-lg hover:shadow-xl hover:shadow-primary/30 transition-all duration-200 min-w-[120px] yes-glow" style={{
          ...
          {noPosition === null ? <button onMouseEnter={moveNoButton} onTouchStart={moveNoButton} onClick={moveNoButton} className="px-6 py-4 rounded-full bg-secondary text-secondary-foreground font-semibold text-base md:text-lg shadow hover:shadow-md min-w-[100px] transition-all duration-300">
      ...
      {noPosition !== null && <button onMouseEnter={moveNoButton} onTouchStart={moveNoButton} onClick={moveNoButton} className="fixed px-6 py-4 rounded-full bg-secondary text-secondary-foreground font-semibold text-base shadow z-50 min-w-[100px]" style={{
