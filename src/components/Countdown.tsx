  ...
  if (diff <= 0) {
    return (
      <div className="text-center">
        <p className="text-2xl font-bold text-primary">It's Valentine's Day! 💕</p>
      </div>
    );
  }
    ...
    <div className="text-center">
      ...
      <div className="flex gap-3 justify-center">
        {units.map((u) => (
          <div
            key={u.label}
            className="bg-card/80 backdrop-blur-sm rounded-2xl px-4 py-3 min-w-[70px] shadow-md border border-primary/10"
          >
